			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbars-rs-food">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item active"><a class="nav-link" href="bangalore.php">go back</a></li>
					</ul>
				</div>
			</div>
		</nav>
...
$code = $_POST['code'];
$result = mysqli_query($con,"SELECT * FROM `caprese` WHERE `code`='$code'");
...
?>
<div class="cart_div">
<a onclick="payment4()"><img src="cart-icon.png" /> Cart<span><?php echo $cart_count; ?></span></a>
</div>
<?php
}

$result = mysqli_query($con,"SELECT * FROM `caprese`");
