...
$code = $_POST['code'];
$result = mysqli_query($con,"SELECT * FROM `indian accent` WHERE `code`='$code'");
...
?>
<div class="cart_div">
<a onclick="payment5()"><img src="cart-icon.png" /> Cart<span><?php echo $cart_count; ?></span></a>
</div>
<?php
}

$result = mysqli_query($con,"SELECT * FROM `indian accent`");
