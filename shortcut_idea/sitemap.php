...
<title>ORDERMANIA | About Us</title>
      ...
      <div class="col-md-12">
        <nav class="navbar navbar-default">
          <div class="navbar-header">
           ...
           <a class="navbar-brand" href="index.php"><img src="images/logo.jpg" alt="logo" class="img-responsive"></a> 
         </div>
    ...
    <div class="row">
      ...
      <div class="col-md-3 col-sm-6 footer_column">
        ...
        <ul class="widget_links">
          ...
          <li><a href="../menu.php">Our Menu</a></li>
          <li><a href="../about.php">About Us</a></li>
		   <li><a href="../contactsaee.php">Contact Us</a></li>
          
          <li><a href="faq.php">Faq's</a></li>
          <li><a href="../gallery.php">Gallery</a></li>
		   <li><a href="sitemap.php">Login/SignUp</a></li>
