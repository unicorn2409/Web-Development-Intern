				...
				<p>
					<div class="dropdown" style="margin: auto;">
						...
						<div id="myDropdown" class="dropdown-content">
							...
							<a href="bangalore.php">Banglore</a>
							<a href="delhi.php">Delhi</a>
						</div>
					</div>
				</p>
		
				<div class="collapse navbar-collapse" id="navbars-rs-food" style="margin-left: 20px;">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item"><a class="nav-link" href="Login_v1/index.html">Sign In</a></li>
		...
		<ul class="slides-container">
			<li class="text-left">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>WELCOME TO <br>  ORDERMANIA </strong></h1>
						</div>
					</div>
				</div>
			</li>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							...
							<p><a class="btn btn-lg btn-circle btn-outline-new-white" href="menu.php">Order Now</a></p>
						</div>
					</div>
				</div>
			</li>
			...
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-12 text-center">
					<div class="inner-column">
						<h1>WELCOME TO <span>ORDERMANIA</span></h1>
						<h4>Little Story</h4>
						...
						<a class="btn btn-lg btn-circle btn-outline-new-white" href="menu.php">Order Now</a>
					</div>
				</div>
		...
		<div class="container">
			...
			<div class="tz-gallery">
				<div class="row">
					...
					<a href="Gallery/saee.php">
						<center>
							<button type="button" class="btn btn-warning btn-lg">
								<span class="badge badge-light" >Go to Gallery</span>
							</button>
						</center>
					</a>
				</div>
	...
	<footer class="footer-area bg-f">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-3 col-md-6">
					<h3>Quick Links</h3>
						<li><a href="games/index.html"><span class="badge badge-light"> Games </span></a>
						<li><a href="games/community.html"><span class="badge badge-light"> Forums </span></a>
							<a href="index.php"><span class="badge badge-light"> Home </span></a>
							<a href="menu.php"><span class="badge badge-light"> Menu </span></a>
							<a href="Gallery/saee.php"><span class="badge badge-light"> Gallery </span></a>
						</li>
						<li>
							<a href="about.php"><span class="badge badge-light"> About Us </span></a>
							<a href="contactsaee.php"><span class="badge badge-light"> Contact Us </span></a>
						</li>
						<li><a href="shortcut_idea/Terms and conditions.php"><span class="badge badge-light"> Terms And Conditions </span></a></li>
						<li><a href="shortcut_idea/faq.php"><span class="badge badge-light"> Faq's </span></a></li>
						<li><a href="shortcut_idea/privacy.php"><span class="badge badge-light"> Privacy </span></a></li>
