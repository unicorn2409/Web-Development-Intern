...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="Login_v1/toast.css">  
    <!-- Responsive CSS -->
...
$code = $_POST['code'];
$result = mysqli_query($con,"SELECT * FROM `thetable1` WHERE `code`='$code'");
...
?>
<div class="cart_div">
<a onclick="payment()"><img src="cart-icon.png" /> Cart<span><?php echo $cart_count; ?></span></a>
</div>
<?php
}
$result = mysqli_query($con,"SELECT * FROM `thetable1`");
if($result){
