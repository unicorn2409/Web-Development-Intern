		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			<div class="container">
				<a class="navbar-brand" href="index.php">
					<img src="img/logo.png" alt="" height = 60px width = 240px/>
				</a>
				...
				<div class="collapse navbar-collapse" id="navbars-rs-food">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item active"><a class="nav-link" href="delhi.php">go back</a></li>
					</ul>
				</div>
			</div>
		</nav>
...
$code = $_POST['code'];
$result = mysqli_query($con,"SELECT * FROM `bukhara restaurant` WHERE `code`='$code'");
...
<body>
<div style="width:700px; margin:250px auto;">
...
?>
<div class="cart_div">
<a onclick="payment6()"><img src="cart-icon.png" /> Cart<span><?php echo $cart_count; ?></span></a>
</div>
<?php
}

$result = mysqli_query($con,"SELECT * FROM `bukhara restaurant`");
...
<?php echo $status; ?>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-3 col-md-6">
					...
					<p class="lead">Ground Floor, Kalapesi Trust Building, Opposite Dhanraj Mahal, Below Hotel Suba Palace, Apollo Bunder Marg, Colaba, Mumbai, Maharashtra 400039</p>
					<p class="lead"><a href="#">+ 022 2282 5000</a></p>
					<p><a href="#"> thetable@admin.com</a></p>
				</div>
				<div class="col-lg-3 col-md-6">
					<h3>Opening hours</h3>
  ...
  <script type="text/javascript" src="Login_v1/toast.js"></script>
</html>