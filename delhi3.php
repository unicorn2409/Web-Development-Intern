...
$code = $_POST['code'];
$result = mysqli_query($con,"SELECT * FROM `the gt road` WHERE `code`='$code'");
...
?>
<div class="cart_div">
<a onclick="payment7()"><img src="cart-icon.png" /> Cart<span><?php echo $cart_count; ?></span></a>
</div>
<?php
}

$result = mysqli_query($con,"SELECT * FROM `the gt road`");
