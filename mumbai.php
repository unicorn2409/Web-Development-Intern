					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="dropdown-a">
								...
								<a class="dropdown-item" href="galleryphp">Gallery</a>
							</div>
						</li>
							...
							<div class="row">
								<div class="col-lg-4 col-md-6 special-grid drinks">
									<div class="gallery-single fix">
										<a><img src="images/restaurants/mumbai_images/mr_1.png" height = 215px width = 360px alt="Image"></a>
										<div class="why-text">
											<center><h1><b>The Table</b></h1></center>
											<p><b>Address :</b>Ground Floor,Kalapesi Trust Building,Opposite Dhanraj Mahal,Colaba, Mumbai, Maharashtra 400039.</p>
											<a href="mumbai1.php">
											<center>
											<button type="button" class="btn btn-warning btn-lg">
												<span class="badge badge-light" >Go to restaurant</span>
											</button>
											</center>
											</a>
										</div>
								...
								<div class="col-lg-4 col-md-6 special-grid drinks">
									<div class="gallery-single fix">
										<a><img src="images/restaurants/mumbai_images/mr_2.png" height = 215px width = 360px alt="Image"></a>
										<div class="why-text">
											<center><h1><b>JW Cafe</b></h1></center>
											<p><b>Address :</b>Chhatrapati Shivaji International Airport Area, Vile Parle, Mumbai, Maharashtra 400099.</p>
											<a href="mumbai2.php">
											<center>
								...
								<div class="col-lg-4 col-md-6 special-grid drinks">
									<div class="gallery-single fix">
										<a><img src="images/restaurants/mumbai_images/mr_3.png" height = 215px width = 360px alt="Image"></a>
										<div class="why-text">
											<center><h1><b>Yauatcha Mumbai</b></h1></center>
											<p><b>Address :</b>Raheja Tower, Bandra Kurla Complex, Bandra East, Mumbai, Maharashtra 400051.</p>
											<a href="mumbai3.php">
											<center>
	...
	<footer class="footer-area bg-f">
		...
		<div class="copyright">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<p class="company-name">All Rights Reserved. &copy; 2018 <a href="#">ORDERMANIA</a></p>
					</div>
				</div>
			</div>
		</div>
